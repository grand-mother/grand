...
class TopographyTest(TestCase):
    ...
    def test_topography_cache(self):
        ...
        c = ECEF(Geodetic(latitude =numpy.array([39.5, 40.5]), 
    ...
    def test_topography_elevation(self):
        ...
        cv = ECEF(Geodetic(latitude=geo.latitude  *o,
                           longitude=geo.longitude*o,
                           height   = geo.height  *o))
    ...
    def test_topography_distance(self):
        ...
        x0 = GRANDCS(x=-8000,y=12000,z=2200, location=geo) # Initial point along traj (in LTP frame)
        v  = numpy.matmul(x0.basis.T, v0)  # GRANDCS --> ECEF. input direction must be in ECEF. ToDo: Fix this.
