...
class GeomagnetTest(TestCase):
    ...
    def __init__(self, *args):
        ...
        #                              height=1000. * u.m)
        self.location = Geodetic(latitude=45.0, longitude=3.0, height=1000.0)
    ...
    def test_default(self):
        ...
        self.assertEqual(tools.geomagnet.obstime, tools.geomagnet._default_obstime)
    ...
    def test_obstime(self):
        ...
        #                 tools.geomagnet._default_obstime.datetime.date)
        self.assertEqual(geomagnet.obstime, tools.geomagnet.obstime)
