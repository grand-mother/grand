...
*Measured 2026-09-24 17:05 UTC by `docs/dev/update_recovery_plan.py`. Everything in this block is generated; edit the script, not the table.*

| | |
|---|---|
| Test suite | **634 passed, 10 skipped, 11 xfailed** — reported by CI run 36030523668 (ROOT 6.36.04) on e5de7b78, not run here |
| Lint | clean over `grand/ tests/ quality/ notebooks/ docs/dev/ granddb/` |
| Branches | 23 contained in `dev-next`, **3 still out**, 9 decided against, 2 absorbed, plus the working branch |
