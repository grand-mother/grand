...
*Measured 2026-09-24 16:00 UTC by `docs/dev/update_recovery_plan.py`. Everything in this block is generated; edit the script, not the table.*

| | |
|---|---|
| Test suite | **633 passed, 10 skipped, 11 xfailed** — reported by CI run 36023116679 (ROOT 6.36.04) on 65d88d32, not run here |
| Lint | clean over `grand/ tests/ quality/ notebooks/ docs/dev/ granddb/` |
| Branches | 22 contained in `dev-next`, **5 still out**, 9 decided against, 2 absorbed |
| Known issues | 20 documented in `known_issues.rst`: 12 open, 7 settled, 1 not classifiable from its :Status: line |
| Notebooks | 10, generated by `notebooks/make_notebooks.py` |
| Tag | `v0.1.0-dev.27`, at `65d88d32` |
