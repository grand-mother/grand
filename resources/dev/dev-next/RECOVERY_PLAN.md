...
*Measured 2026-09-24 13:34 UTC by `docs/dev/update_recovery_plan.py`. Everything in this block is generated; edit the script, not the table.*

| | |
|---|---|
| Test suite | **601 passed, 18 skipped, 10 xfailed, 1 xpassed, 273 warnings** |
| Lint | clean over `grand/ tests/ quality/ notebooks/ docs/dev/ granddb/` |
| Branches | 23 contained in `dev-next`, **6 still out**, 7 decided against, 1 absorbed |
| Known issues | 18 documented in `known_issues.rst`: 12 open, 5 settled, 1 not classifiable from its :Status: line |
| Notebooks | 10, generated by `notebooks/make_notebooks.py` |
| Tag | `v0.1.0-dev.27`, at `b2c4cf1` |
