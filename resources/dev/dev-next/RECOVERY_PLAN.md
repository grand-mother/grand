...
*Measured 2026-09-24 22:09 UTC by `docs/dev/update_recovery_plan.py`. Everything in this block is generated; edit the script, not the table.*
...
| Branches | 23 contained in `dev-next`, **2 still out**, 9 decided against, 3 absorbed, plus the working branch |
