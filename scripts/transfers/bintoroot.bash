...
#gtot_path='/sps/grand/prod_grand/DB_TESTS/gtot/cmake-build-release/gtot'
# path to script to register convertion results
#register_convertion='/sps/grand/prod_grand/DB_TESTS/grand/scripts/transfers/register_convert.py'
# path to script to register root file into the DB
#register_root='/sps/grand/prod_grand/DB_TESTS/grand/granddb/register_file_in_db.py'
#register_dir='/sps/grand/prod_grand/DB_TESTS/grand/granddb/register_dir_in_db.py'
#config_file='/sps/grand/prod_grand/DB_TESTS/grand/granddb/config.ini'
#sps_path='/sps/grand/'
#irods_path='/grand/home/trirods/'
#submit_base_name=''
